...
Phoenix is an AI-native, globally scalable social platform centered on voice communities, digital identity, creator economy, real-time communication, digital gifts, agencies, moderation, analytics, and extensibility.
...
## Repository Status
- Version: `1.1.0-governance-r2`
- Phase: Foundation and Architecture Baseline
- Implementation status: Documentation-first; production code not yet generated

## Read First

1. `docs/00_Governance/000_READ_FIRST.md`

1. `docs/00_Constitution/000_Phoenix_Constitution_v2.md`
2. `MASTER_INDEX.md`
3. `AI_CONTEXT.md`
4. `docs/01_Executive/001_Executive_Blueprint.md`
