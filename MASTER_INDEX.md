...
- [Architect Notes](ARCHITECT_NOTES.md)
- [Repository Integrity Report](REPOSITORY_INTEGRITY_REPORT.md)

## Governance

- [Governance Corpus](docs/00_Governance/)
- [Constitution](docs/00_Constitution/)

## Data Platform — Canonical

- [DPL-000 — Read First](docs/04_Data_Platform/000_READ_FIRST.md)
...
- [DPL-015 — Data Consistency Model](docs/04_Data_Platform/015_Data_Consistency_Model.md)
- [DPL-016 — Data Versioning](docs/04_Data_Platform/016_Data_Versioning.md)
- [DPL-017 — Audit Strategy](docs/04_Data_Platform/017_Audit_Strategy.md)
- [DPL-018 — Data Contracts](docs/04_Data_Platform/018_Data_Contracts.md)
- [DPL-019 — Event Modeling](docs/04_Data_Platform/019_Event_Modeling.md)

## Engineering Framework

- [PEF-000 — Read First](docs/90_Engineering_Framework/000_READ_FIRST.md)
- [PEF-001 — Engineering Principles](docs/90_Engineering_Framework/001_Engineering_Principles.md)
- [PES-001 — Documentation Standard](docs/90_Engineering_Framework/002_Documentation_Standard.md)
- [PES-002 — Architecture Standard](docs/90_Engineering_Framework/003_Architecture_Standard.md)
...
- [SEC-000 — Read First](docs/08_Security/000_READ_FIRST.md)
- [SEC-001 — Security Vision and Principles](docs/08_Security/001_Security_Vision_and_Principles.md)
- [SEC-002 — Threat Model](docs/08_Security/002_Threat_Model.md)
- [SEC-003 — Identity and Authentication](docs/08_Security/003_Identity_and_Authentication.md)
- [SEC-004 — Authorization and Access Control](docs/08_Security/004_Authorization_and_Access_Control.md)
- [SEC-005 — Secrets and Key Management](docs/08_Security/005_Secrets_and_Key_Management.md)
...
- [DDD](docs/06_DDD/)
- [Architecture](docs/07_Architecture/)
- [Database](docs/08_Database/)
- [API](docs/09_API/)
- [Backend](docs/11_Backend/)
- [AI](docs/13_AI/)
- [Security](docs/14_Security/)
- [Cloud](docs/15_Cloud/)
- [Testing](docs/16_Testing/)
- [Deployment](docs/17_Deployment/)
- [Operations](docs/18_Operations/)
...
- [ID2-015 — Phase B Charter](docs/15_Identity_Slice2/015_Phase_B_Charter.md)
- [ID2-016 — Passkey and WebAuthn Architecture](docs/15_Identity_Slice2/016_Passkey_WebAuthn_Architecture.md)
- [ID2-017 — TOTP MFA and Recovery Codes](docs/15_Identity_Slice2/017_TOTP_MFA_and_Recovery_Codes.md)
- [ID2-018 — Breached-password Screening](docs/15_Identity_Slice2/018_Breached_Password_Screening.md)
- [ID2-019 — Production Notification Delivery](docs/15_Identity_Slice2/019_Production_Notification_Delivery.md)
- [ID2-020 — Sensitive-action Reauthentication](docs/15_Identity_Slice2/020_Sensitive_Action_Reauthentication.md)
- [ID2-021 — Phase B Threat Model](docs/15_Identity_Slice2/021_Phase_B_Threat_Model.md)
- [ID2-022 — Phase B ASVS Traceability](docs/15_Identity_Slice2/022_Phase_B_ASVS_Traceability.md)
