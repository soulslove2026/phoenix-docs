...
- [004 — Business Model and Revenue Strategy](docs/04_Business/004_Business_Model_and_Revenue_Strategy.md)
- [005 — Product Roadmap](docs/05_Roadmap/005_Product_Roadmap.md)

## Architecture
- [006 — Domain-Driven Design](docs/06_DDD/006_Domain_Driven_Design.md)
- [007 — Enterprise System Architecture](docs/07_Architecture/007_Enterprise_System_Architecture.md)
- [C4 Context Diagram](architecture/c4/context.mmd)
- [C4 Container Diagram](architecture/c4/containers.mmd)
- [Initial ERD](architecture/erd/core-domain-erd.mmd)

## Decisions
- [ADR-001 — Multi-Source Revenue](adr/ADR-001-multi-source-revenue.md)
...
- [AI Coding Protocol](ai/coding-rules/AI_CODING_PROTOCOL.md)
- [Project Context](ai/context/PROJECT_CONTEXT.md)

## Planned Next Documents
008 C4 Context Model  
009 C4 Container Model  
010 C4 Component Model  
011 Context Mapping  
012 Identity Domain Bible  
013 Social Graph Domain Bible  
014 Voice Rooms Domain Bible  
015 Messaging Domain Bible  
